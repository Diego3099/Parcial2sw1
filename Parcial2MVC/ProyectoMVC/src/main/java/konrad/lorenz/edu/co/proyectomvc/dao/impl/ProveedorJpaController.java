 ...
 * @author AD1SIS008
 */
public class ProveedorJpaController implements Serializable, ProveedorDAO {
    ...
    public void create(Proveedor proveedor) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findProveedor(proveedor.getNitProveedor()) != null) {
    ...
    public void edit(Proveedor proveedor) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = proveedor.getNitProveedor();
