 ...
 * @author AD1SIS008
 */
public class UsuariosJpaController implements Serializable, UsuariosDAO {
    ...
    public void create(Usuarios usuarios) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findUsuarios(usuarios.getCedulaUsuario()) != null) {
    ...
    public void edit(Usuarios usuarios) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = usuarios.getCedulaUsuario();
