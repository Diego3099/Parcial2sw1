...
public class Proveedor implements Serializable {
    ...
    public Proveedor(Integer nitProveedor) {
        this.nitProveedor = nitProveedor;
    }

    public Proveedor(Integer nitProveedor, String nombreProveedor) {
        this.nitProveedor = nitProveedor;
    ...
    public String toString() {
        return "konrad.lorenz.edu.co.proyectomvc.modelo.Proveedor[ nitProveedor=" + nitProveedor + " ]";
    }
